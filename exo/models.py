...
model_cards: ModelCardCollection = {
  ...
  "Qwen3-30B-A3B-8bit": ModelCard(
    ...
    layers=48,
    repo={
      "MLXDynamicShardInferenceEngine": "mlx-community/Qwen3-30B-A3B-8bit",
    },
  ),
  "Qwen3-30B-A3B-bf16": ModelCard(
    pretty_name="Qwen3-30B-A3B-bf16",
    layers=48,
    repo={
      "MLXDynamicShardInferenceEngine": "mlx-community/Qwen3-30B-A3B-bf16",
    },
  ),
